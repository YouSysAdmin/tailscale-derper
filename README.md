...
| DERP_ACE_ENABLE                      | -ace                             | false                          | enable ACE (experimental new transport)                                                                                                                                                                                                                 |
| DERP_ACME_EAB_KEY                    | -acme-eab-key                    | ""                             | ACME External Account Binding HMAC key (base64-url) for CAs that require EAB                                                                                                                                                                            |
| DERP_ACME_EAB_KID                    | -acme-eab-kid                    | ""                             | ACME External Account Binding key ID for CAs that require EAB                                                                                                                                                                                           |
| DERP_ACME_EMAIL                      | -acme-email                      | ""                             | optional email address for ACME account registration                                                                                                                                                                                                    |
...
| DERP_RATE_CONFIG                     | -rate-config                     | ""                             | optional path to per-client rate-limit config file                                                                                                                                                                                                      |
